...
//            if (CGRectContainsPoint(self.view.bounds, currentView.center)) {
                ...
                if([self.topViewController isKindOfClass:[YYMessageDetailViewController class]]){
...
- (BOOL)gestureRecognizer:(UIGestureRecognizer *)gestureRecognizer shouldReceiveTouch:(UITouch *)touch{
    if ([touch.view.superview isKindOfClass:[YYMessagePersonalCell class]] && [gestureRecognizer isKindOfClass:[UIPanGestureRecognizer class]]) {
