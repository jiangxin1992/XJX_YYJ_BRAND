...
- (void)viewWillAppear:(BOOL)animated{
    ...
    if(_viewType == YYBrandModifyInfoCellViewDesc){
        // 进入埋点
        [MobClick beginLogPageView:kYYPageBrandModifyInfoCellDesc];
    }else if(_viewType == YYBrandModifyInfoCellViewConnBrand){
        // 进入埋点
        [MobClick beginLogPageView:kYYPageBrandModifyInfoCellConnBrand];
    }else if(_viewType == YYBrandModifyInfoCellViewWebsite)
    {
        // 进入埋点
        [MobClick beginLogPageView:kYYPageBrandModifyInfoCellWebsite];
    }else if(_viewType == YYBrandModifyInfoCellViewContactTxt){
        if([_detailType isEqualToString:@"email"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellContactTxtEmail];
        }else if([_detailType isEqualToString:@"weixin"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellContactTxtWeChat];
        }else if([_detailType isEqualToString:@"qq"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellQQ];
        }
    }else if(_viewType == YYBrandModifyInfoCellViewContactMobile){
        // 进入埋点
        [MobClick beginLogPageView:kYYPageBrandModifyInfoCellContactMobile];
    }else if(_viewType == YYBrandModifyInfoCellViewContactTelephone){
        // 进入埋点
        [MobClick beginLogPageView:kYYPageBrandModifyInfoCellContactTelephone];
    }else if(_viewType == YYBrandModifyInfoCellViewSocial){
        if([_detailType isEqualToString:@"social_weixin"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellSocialWeChat];
        }else if([_detailType isEqualToString:@"social_sina"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellSocialSina];
        }else if([_detailType isEqualToString:@"social_instagram"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellIns];
        }else if([_detailType isEqualToString:@"social_facebook"])
        {
            // 进入埋点
            [MobClick beginLogPageView:kYYPageBrandModifyInfoCellFacebook];
        }
    }
}
...
- (void)viewWillDisappear:(BOOL)animated{
    ...
    if(_viewType == YYBrandModifyInfoCellViewDesc){
        // 退出埋点
        [MobClick endLogPageView:kYYPageBrandModifyInfoCellDesc];
    }else if(_viewType == YYBrandModifyInfoCellViewConnBrand){
        // 退出埋点
        [MobClick endLogPageView:kYYPageBrandModifyInfoCellConnBrand];
    }else if(_viewType == YYBrandModifyInfoCellViewWebsite)
    {
        // 退出埋点
        [MobClick endLogPageView:kYYPageBrandModifyInfoCellWebsite];
    }else if(_viewType == YYBrandModifyInfoCellViewContactTxt){
        if([_detailType isEqualToString:@"email"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellContactTxtEmail];
        }else if([_detailType isEqualToString:@"weixin"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellContactTxtWeChat];
        }else if([_detailType isEqualToString:@"qq"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellQQ];
        }
    }else if(_viewType == YYBrandModifyInfoCellViewContactMobile){
        // 退出埋点
        [MobClick endLogPageView:kYYPageBrandModifyInfoCellContactMobile];
    }else if(_viewType == YYBrandModifyInfoCellViewContactTelephone){
        // 退出埋点
        [MobClick endLogPageView:kYYPageBrandModifyInfoCellContactTelephone];
    }else if(_viewType == YYBrandModifyInfoCellViewSocial){
        if([_detailType isEqualToString:@"social_weixin"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellSocialWeChat];
        }else if([_detailType isEqualToString:@"social_sina"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellSocialSina];
        }else if([_detailType isEqualToString:@"social_instagram"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellIns];
        }else if([_detailType isEqualToString:@"social_facebook"])
        {
            // 退出埋点
            [MobClick endLogPageView:kYYPageBrandModifyInfoCellFacebook];
        }
    }
}
...
-(void)PrepareUI
{
    ...
    NSString *_nowTitle = @"";
    if(_viewType == YYBrandModifyInfoCellViewDesc){
        _nowTitle = NSLocalizedString(@"品牌简介",nil);
    }else if(_viewType == YYBrandModifyInfoCellViewConnBrand){
...
-(void)selectLimit{
    if(self.limitTypePickerView == nil){
        ...
        self.limitTypePickerView.uidataType = UIDataTypeModifyLimit;
    }else
    {
        [self.limitTypePickerView show:self.view];
    }
