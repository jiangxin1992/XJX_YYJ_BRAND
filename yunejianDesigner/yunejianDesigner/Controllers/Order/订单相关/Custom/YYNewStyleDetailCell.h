...
@class YYOrderStyleModel, YYOrderOneInfoModel,YYOrderSeriesModel;
...
@property (nonatomic, assign) NSInteger isModifyNow;//当前是否是修改状态0 没有修改  1购物车 2购物车编辑 3订单修改 4订单失效 5追单
