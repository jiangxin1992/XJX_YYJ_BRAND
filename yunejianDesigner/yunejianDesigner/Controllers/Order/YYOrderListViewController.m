...
-(void)addPaylogRecordWithListItemModel:(YYOrderListItemModel *)orderListItemModel{
    ...
    [[YYYellowPanelManage instance] showOrderAddMoneyLogPanel:@"Order" andIdentifier:@"YYOrderAddMoneyLogController" orderCode:orderListItemModel.orderCode totalMoney:[orderListItemModel.finalTotalPrice doubleValue] moneyType:[orderListItemModel.curType integerValue] parentView:self andCallBack:^(NSString *orderCode, NSNumber *totalPercent) {
